 ...
 * @author Paul Hammant
 */
public class JakartaAnnotationParanamer implements Paranamer {
    ...
    public JakartaAnnotationParanamer() {
        this(new NullParanamer());
    }

    public JakartaAnnotationParanamer(Paranamer fallback) {
    ...
    protected String getNamedValue(Annotation ann) {
        if ("jakarta.inject.Named".equals(ann.annotationType().getName())) {
